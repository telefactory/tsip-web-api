...
return [
    ...
    */
    ...
    'connections' => [
        ...
        'customers' => [
            'driver' => env('DB_CUSTOMERS_CONNECTION', 'mysql'),
            'host' => env('DB_CUSTOMERS_HOST', '127.0.0.1'),
            'port' => env('DB_CUSTOMERS_PORT', '3306'),
            'database' => env('DB_CUSTOMERS_DATABASE', 'forge'),
            'username' => env('DB_CUSTOMERS_USERNAME', 'forge'),
        ...
        'stats' => [
            'driver' => env('DB_STATS_CONNECTION', 'mysql'),
